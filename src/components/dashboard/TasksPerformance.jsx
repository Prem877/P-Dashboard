...
import { CheckCircle, MoreVertical, TrendingDown, TrendingUp } from 'react-feather';
        ...
        <Card className="h-100">
            <Card.Body>
                ...
                <div className="d-flex align-items-center justify-content-around">
                    ...
                    <div className="text-center">
                        <TrendingUp className="text-warning fs-3" />
                        <h1 className="mt-3  mb-1 fw-bold">32%</h1>
                        <p>In-Progress</p>
                    </div>
                    <div className="text-center">
                        <TrendingDown className="text-danger fs-3" />
